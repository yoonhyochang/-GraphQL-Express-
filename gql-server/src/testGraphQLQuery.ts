// *5.1. 수동으로 쿼리를 만들고 스키마 파일을 입력할 수 있는  graphql, GraphQLSchema를 불러옴
import { graphql, GraphQLSchema } from "graphql";

// *5.2.파라미터의 사용 여부를 나타내는 GraphQl 타입인 Maybe를 불러옴
import { Maybe } from "graphql/jsutils/Maybe";

//  *5.3. Options 인터페이스를 정의하고 나중에 testGraphQLQuery 함수에서 쿼리를 실행할 때 파라미터의 타입으로 사용됨
interface Options {
...
//*5.4 getuser,test.ls 파일을 만들고 테스트를 작성
